  ...
  return (
    <section className={styles.recordSection} id="change-record">
      <div className={`${styles.container} ${styles.recordGrid}`}>
        <div className={styles.recordCopy}><p className={styles.sectionLabel}>A change record</p><h2>The summary is only the starting point.</h2><p>Morrow keeps the old text, the new text and the source capture together so you can verify the change.</p></div>
        <article className={styles.recordPreview} aria-label="Illustrative change record">
          ...
          <div className={styles.evidenceFoot}><i aria-hidden="true" />Source capture available</div>
        </article>
      </div>
    </section>
  );
