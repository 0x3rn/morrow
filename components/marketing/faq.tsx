...
const questions = [
  ...
  { question: "What happens when an ignored region changes?", answer: "The capture can still be preserved, but changes that exist only inside ignored regions do not create a change record." },
  { question: "Does Morrow keep evidence of the page it checked?", answer: "Yes. Morrow keeps the captured page so a recorded change can be traced back to what it saw." },
  ...
  { question: "What does Morrow show when a change is recorded?", answer: "A change record can include the category, significance, summary, previous text, current text and source capture." },
];
